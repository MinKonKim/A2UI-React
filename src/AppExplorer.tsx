...
export default function AppExplorer() {
  ...
  if (exampleFiles.length === 0) {
    return (
      <div className={styles.app} style={{padding: '2rem', color: '#e2e8f0'}}>
        <h1 className={styles.h1}>A2UI React Explorer</h1>
        <p style={{marginTop: '1rem', lineHeight: 1.6}}>
          등록된 예시 JSON이 없습니다. <code>src/examples.tsx</code>의 <code>import.meta.glob</code> 경로를
          확인하세요.
        </p>
      </div>
    );
              ...
              <div className={styles.logList}>
                ...
                {logs.map((log, i) => (
                  <div key={i} className={styles.logEntry}>
                    ...
                    <pre
                      style={{margin: '4px 0 0 0', whiteSpace: 'pre-wrap', wordBreak: 'break-all'}}
                    >
